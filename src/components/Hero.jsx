    ...
    return (
        <div className='bg-dull-white w-full h-fit'>
            <div className='w-full py-10 md:py-20 pt-25 md:pt-40 px-[4vw] flex items-center relative'>
                ...
                <div className="scale-50 origin-top-right md:scale-100 absolute top-[40%] right-0">
            ...
            <div className='w-full relative'>
                <hr />
                <div className='flex flex-col md:flex-row gap-5 justify-between px-10 py-5 font-[NeueMontreal]'>
